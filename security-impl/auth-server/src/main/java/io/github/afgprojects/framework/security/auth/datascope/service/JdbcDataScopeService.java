...
import io.github.afgprojects.framework.security.auth.datascope.entity.SecUserDataScope;
...
public class JdbcDataScopeService {
    ...
    public JdbcDataScopeService(DataManager dataManager, JdbcDeptService deptService) {
