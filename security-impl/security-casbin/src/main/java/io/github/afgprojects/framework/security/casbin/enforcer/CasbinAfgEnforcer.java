...
import io.github.afgprojects.framework.security.casbin.config.CasbinProperties;
import io.github.afgprojects.framework.security.casbin.model.AfgPolicyService;
import io.github.afgprojects.framework.security.casbin.model.CasbinRule;
...
public class CasbinAfgEnforcer implements AfgEnforcer {
     ...
     */
    public CasbinAfgEnforcer(CasbinProperties properties, AfgPolicyService policyService) {
    ...
    private Enforcer createEnforcer() {
        ...
        String modelText = properties.getModelText() != null
                ? properties.getModelText()
                : properties.getDefaultModelText();
        ...
        enf.enableAutoSave(properties.isAutoSave());
        enf.enableAutoBuildRoleLinks(properties.isAutoBuildRoleLinks());
