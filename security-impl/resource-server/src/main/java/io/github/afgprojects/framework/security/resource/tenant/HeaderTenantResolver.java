...
public class HeaderTenantResolver implements TenantResolver {
    ...
    private int order = TenantResolveStrategy.HEADER.getOrder();
     ...
     */
    public HeaderTenantResolver(@NonNull String headerName) {
    ...
    public TenantContext resolve(@NonNull HttpServletRequest request) {
        ...
        return new DefaultTenantContext(tenantId.trim());
    }
