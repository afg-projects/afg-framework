...
class LoggingAutoConfigurationIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    @DisplayName("应该成功注入 LoggingConfig Bean")
    void shouldInjectLoggingConfig() {
        // when
        AfgCoreProperties.LoggingConfig properties = getBean(AfgCoreProperties.class).getLogging();
    ...
    @Test
    @DisplayName("LoggingConfig 默认配置应该正确")
    ...
    void allLoggingBeansShouldBeAvailable() {
        ...
        // LoggingConfig bean name is auto-generated by Spring Boot
        String[] beanNames = applicationContext.getBeanNamesForType(AfgCoreProperties.class);
