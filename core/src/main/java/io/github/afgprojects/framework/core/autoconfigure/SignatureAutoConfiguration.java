...
import io.github.afgprojects.framework.core.web.security.signature.NonceCache;
import io.github.afgprojects.framework.core.web.security.signature.SignatureGenerator;
import io.github.afgprojects.framework.core.web.security.signature.SignatureInterceptor;
...
public class SignatureAutoConfiguration implements WebMvcConfigurer {
    ...
    public SignatureAutoConfiguration(AfgCoreProperties properties) {
    ...
    public NonceCache nonceCache() {
        return new NonceCache(properties.getSecurity().getSignature().getNonceCacheSize());
    }
