...
import io.github.afgprojects.framework.core.audit.*;
...
public class AuditLogAutoConfiguration {
    ...
    public AuditLogAspect auditLogAspect(@NonNull AuditLogStorage storage, @NonNull AfgCoreProperties properties) {
